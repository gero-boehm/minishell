...
// /*   Updated: 2023/08/03 17:25:38 by gbohm            ###   ########.fr       */
// /*                                                                            */
// /* ************************************************************************** */
...
// 	command00.data.builtin_echo.str = "hello $VAR";
...
// 	var.range.start = 6;
// 	var.range.length = 4;
// 	if (arr_add(&command00.data.builtin_echo.vars, &var))
// 		return (1);
...
// 	if (arr_create(&command00.data.external.vars, sizeof(t_var)))
// 		return (1);
// 	if (arr_add(&chain0.commands, &command00))
// 		return (1);
...
// 	if (arr_create(&command01.data.external.vars, sizeof(t_var)))
// 		return (1);
// 	if (arr_add(&chain0.commands, &command01))
// 		return (1);
...
// 	if (arr_create(&command02.data.external.vars, sizeof(t_var)))
// 		return (1);
// 	if (arr_add(&chain0.commands, &command02))
// 		return (1);
...
// 	if (arr_create(&command00.data.external.heredoc.vars, sizeof(t_var)))
// 		return (1);
...
// 	if (arr_create(&command10.data.external.vars, sizeof(t_var)))
// 		return (1);
...
// 	if (arr_create(&command20.data.external.vars, sizeof(t_var)))
// 		return (1);
...
// 	if (arr_create(&command11.data.external.vars, sizeof(t_var)))
// 		return (1);
// 	if (arr_add(&chain1.commands, &command11))
// 		return (1);
...
// 	if (arr_create(&command12.data.external.vars, sizeof(t_var)))
// 		return (1);
// 	if (arr_add(&chain1.commands, &command12))
// 		return (1);
...
// 	if (arr_create(&command21.data.external.vars, sizeof(t_var)))
// 		return (1);
// 	if (arr_add(&chain2.commands, &command21))
// 		return (1);
